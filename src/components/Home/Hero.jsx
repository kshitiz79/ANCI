...
const Hero = () => {
  const sliderImages = ["/hero2.jpg", "/hero1.jpg", "/hero3.jpg"];
  ...
  return (
    <div className="relative h-auto bg-[#7c0c2b]">
      ...
      {/* Overlay for Text */}
      <div className="bg-black bg-opacity-30 absolute inset-0 flex items-center lg:h-[86vh]  ">
        <div className="max-w-[1400px] mx-auto px-6 md:px-14 w-full">
          <div className="w-full lg:w-1/2">
            ...
            <h2 className="text-sm md:text-xl text-white mb-6 font-sans font-thin leading-relaxed">
              ...
              <br />
             with 2+ decade experience
            </h2>
            <Link href="/service-page" className="bg-[#7c0c2b] text-white lg:px-6 lg:py-3 px-4 py-2 rounded-md hover:bg-red-900 font-sans font-thin transition">
